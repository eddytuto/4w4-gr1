...
function cidw_4w4_enqueue(){
    ...
    wp_enqueue_script('cidw-4w4-le-script', get_template_directory_uri() . '/javascript/boite-modale.js', array(), filemtime(get_template_directory() . '/javascript/boite-modale.js'), true);
   }
